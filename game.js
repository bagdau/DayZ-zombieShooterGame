...
const backgroundMusic = new Audio('C:/Users/BAGDAULET PC/Desktop/100-Зомби/themes/Alex-Besss-Alien.mp3'); // Path to your background music file
backgroundMusic.loop = true; // Set it to loop
backgroundMusic.volume = 0.5; // Set the volume (0 to 1)
